...
- **Creación de Subclases:**
  - Se crearon los archivos auto.py, moto.py y camion.py, implementando herencia desde la clase base Vehiculo.
- **Especialización de Clases:**
  ...
  - **Auto (auto.py):** Se implementó constructor propio llamando a super().__init__() y se definió el atributo privado __capacidad_maletero (en litros).
